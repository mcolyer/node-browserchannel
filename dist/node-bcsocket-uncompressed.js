  ...
  try {
    if(a == this.q) {
      a: {
        ...
        if(this.F) {
          if(4 == b && S(this), this.sb ? (lc(this, b, d), Ba && 3 == b && (Xb(this.Da, this.Ma, Ub, this.ic), this.Ma.start())) : (mc(this.a, this.C, d, k), nc(this, d)), this.F && !this.aa) {
...
q.send = function(a, b, c, d) {
  ...
  "withCredentials" in this.f && (this.f.withCredentials = this.lc);
  try {
...
q.Gb = function() {
  !this.cb && !this.Ia && !this.Y ? this.dc() : Xc(this)
};
q.dc = function() {
  Xc(this)
};
      ...
      if(7 < this.ba) {
        ...
        if(t(c) && 3 == c.length) {
          ...
          if(0 == e[0]) {
            ...
            this.Cb = e[1], c = this.Cb - this.qa, 0 < c && (e = e[2], this.a.debug(e + " bytes (in " + c + " arrays) are outstanding on the BackChannel"), 37500 > e && (this.jb && 0 == this.$) && !this.W && (this.W = U(w(this.cc, this), 6E3)))
          }
        }else {
